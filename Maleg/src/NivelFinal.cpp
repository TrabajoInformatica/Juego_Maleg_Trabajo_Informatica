...
void NivelFinal::Inicializa(Heroe h) {
	...
	BolaFuego* b0 = new BolaFuego(13.0, 33.0, -1.0);
	bolasdefuego.AgregarE(b0);
	BolaFuego* b1 = new BolaFuego(20.0, 39.0, -1.0);
	bolasdefuego.AgregarE(b1);
	BolaFuego* b2 = new BolaFuego(9.0, 46.0, -1.5);
	bolasdefuego.AgregarE(b2);
	BolaFuego* b3 = new BolaFuego(25.0, 53.0, -1.5);
	bolasdefuego.AgregarE(b3);
	BolaFuego* b4 = new BolaFuego(29.0, 55.0, -1.0);
	bolasdefuego.AgregarE(b4);
	BolaFuego* b5 = new BolaFuego(33.0, 60.0, -1.0);
	bolasdefuego.AgregarE(b5);
	BolaFuego* b6 = new BolaFuego(15.0, 60.0, -1.0);
	bolasdefuego.AgregarE(b6);
	BolaFuego* b7 = new BolaFuego(40.0, 67.0, -1.0);
	bolasdefuego.AgregarE(b7);
	BolaFuego* b8 = new BolaFuego(44.0, 72.0, -0.6);
	bolasdefuego.AgregarE(b8);
	BolaFuego* b9 = new BolaFuego(16.0, 74.0, -1.0);
	bolasdefuego.AgregarE(b9);
	BolaFuego* b10 = new BolaFuego(26.0, 75.0, -1.0);
	bolasdefuego.AgregarE(b10);
	BolaFuego* b11 = new BolaFuego(37.0, 77.0, -1.0);
	bolasdefuego.AgregarE(b11);
	BolaFuego* b12 = new BolaFuego(45.0, 80.0, -1.5);
	bolasdefuego.AgregarE(b12);
	BolaFuego* b13 = new BolaFuego(40.0, 81.0, -1.0);
	bolasdefuego.AgregarE(b13);
	BolaFuego* b14 = new BolaFuego(20.0, 89.0, -1.0);
	bolasdefuego.AgregarE(b14);
	BolaFuego* b15 = new BolaFuego(10.0, 89.0, -1.0);
	bolasdefuego.AgregarE(b15);
	BolaFuego* b16 = new BolaFuego(33.0, 94.0, -1.0);
	bolasdefuego.AgregarE(b16);
	BolaFuego* b17 = new BolaFuego(37.0, 99.0, -1.5);
	bolasdefuego.AgregarE(b17);
	BolaFuego* b18 = new BolaFuego(25.0, 102.0, -1.0);
	bolasdefuego.AgregarE(b18);
	BolaFuego* b19 = new BolaFuego(40.0, 103.0, -1.5);
	bolasdefuego.AgregarE(b19);
	BolaFuego* b20 = new BolaFuego(18.0, 110.0, -1.0);
	bolasdefuego.AgregarE(b20);
	BolaFuego* b21 = new BolaFuego(25.0, 112.0, -1.0);
	bolasdefuego.AgregarE(b21);
	BolaFuego* b22 = new BolaFuego(42.0, 115.0, -1.0);
	bolasdefuego.AgregarE(b22);
	BolaFuego* b23 = new BolaFuego(33.0, 115.0, -1.0);
	bolasdefuego.AgregarE(b23);
	BolaFuego* b24 = new BolaFuego(37.0, 119.0, -1.0);
	bolasdefuego.AgregarE(b24);
	BolaFuego* b25 = new BolaFuego(25.0, 120.0, -1.0);
